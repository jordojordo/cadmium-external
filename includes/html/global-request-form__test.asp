    ...
    <div id="contactCard" class="card ">
      ...
      <div class="p-3">
        ...
        <form 
          ...
          id="contactForm" 
          action="/contact/forms/request_info_test.asp" 
          method="POST" 
            ...
            <div class="md-form pb-3">
              <div class="text-justify">
                ...
                <label class="form-check-label" for="newsletter">
                  ...
                  <a href="https://www.cadmiumcd.com/cadmiumcd/privacy.asp">Privacy Policy</a> 
                  and acknowledge that I may 
                  <a href="http://www.cadmiumcd.com/mydata">unsubscribe</a> 
                  at anytime.
                </label>
              </div>
            </div>
